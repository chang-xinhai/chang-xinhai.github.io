...
\begin{document}
    ...
    \begin{onecolentry}
        \begin{highlights}
            ...
            \item \textbf{Chang, X.}, Zhou, K. (2025). \textit{Neural Surface Reconstruction from Sparse Views Using Epipolar Geometry}. Under Review.
        \end{highlights}
        \vspace{0.2cm}
    ...
    \begin{onecolentry}
        \textbf{EpiS: Neural Surface Reconstruction from Sparse Views Using Epipolar Geometry} \hfill Preprint
    \end{onecolentry}
    \begin{onecolentry}
        \begin{highlights}
