...
\begin{document}
    ...
    \begin{header}
       ...
       Beijing, China \kern 5.0pt \AND \kern 5.0pt
        ...
        {\color{gray!100}\small June 18, 2026} \\
        \vspace{3pt}
    ...
    \begin{twocolentry}{Expected: Jun 2027}
        \textbf{Peking University}, Beijing, China \\
        Bachelor of Science in Data Science and Artificial Intelligence, Yuanpei College
    \end{twocolentry}
    ...
    \begin{twocolentry}{Jun 2026 - Present}
        \textbf{VCL Lab, Peking University} \\
        \textit{Research Assistant (Advised by Prof. Wenzheng Chen)}
    \end{twocolentry}
    \vspace{0.10cm}
    \begin{onecolentry}
        \begin{highlights}
            \item Focused on the full \textbf{Real-Sim-Real} pipeline, including world modeling, robot manipulation, and 3D perception.
        \end{highlights}
    \end{onecolentry}

    \vspace{0.2cm}

    \begin{twocolentry}{Mar 2025 - Jun 2026}
    ...
    \begin{twocolentry}{Mar 2024 - Present}
        \textbf{Media Lab and EECS, MIT} \\
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item Niu, Y.*, \textbf{Chang, X.}*, Liu, X.*, Jiao, Z., Zhu, Y. (2026). \textit{A Scalable Whole-body Trajectory Generator for Coordinated Mobile Manipulation}. The IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR) \textbf{Highlight}.
            \item Zhou, K., Chen, Y., Zhan, F., Hua, H., Chen, G., \textbf{Chang, X.}, Qu, A., Du, Y., Liu, Z., Liang, P. P., Wang, M. (2026). \textit{GEM-4D: Geometry-Enhanced Video World Models for Robot Manipulation}. European Conference on Computer Vision (ECCV).
            ...
            \item Zhou, K., Wang, Y.*, Chen, G.*, \textbf{Chang, X.}*, Beaudouin, G., Zhan, F., Liang, P. P., Wang, M. (2026). \textit{PAGE-4D: Disentangled Pose and Geometry Estimation for 4D Perception}. International Conference on Learning Representations (ICLR).
            \item \textbf{Chang, X.}, Zhou, K. (2026). \textit{Neural Surface Reconstruction from Sparse Views Using Epipolar Geometry}. CVPR 2026 Workshop A2AMML.
            \item Zhou, K.*, Hong, L.*, \textbf{Chang, X.}*, Zhong, Y., Xie, E., Dong, H., Li, Z., Yang, Y., Li, Z., Zhang, W. (2025). \textit{SplatMesh: Interactive 3D Segmentation and Editing Using Mesh-Based Gaussian Splatting}. CVPR Workshop (CVPRW).
            % \item Tang, C.*, \textbf{Chang, X.}* (2025). \textit{StyleCraft: High-Quality Arbitrary Style Transfer via Unified Content-Style Fusion}. International Conference on Intelligent Computing (ICIC) (Oral).
            % \item Tang, C.*, \textbf{Chang, X.}* (2025). \textit{AADNet: A Human-Mind-Inspired Multi-Modal Framework for Object Concept Learning}. IEEE International Conference on Systems, Man, and Cybernetics (SMC).
        \end{highlights}
    \end{onecolentry}
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item Zhou, K.*, \textbf{Chang, X.}*, Kim, T.*, Zhang, J.*, Cao, Y., Peng, C., Zhan, F., Zhao, H., Dong, H., Ting, K. M., Zhu, Y. (2026). \textit{RAD: A Realistic Multi-View Benchmark for Pose-Agnostic Anomaly Detection}. Under Review.
            \item Zhou, K.*, Bai, Z.*, \textbf{Chang, X.}*, Wang, M., Liang, P. P., Zhan, F. (2026). \textit{Stream3D: Sequential Multi-View 3D Generation via Evidential Memory}. Preprint.
            \item Li, J., Zhang, B., \textbf{Chang, X.}, Chen, W. (2026). \textit{NSL-SLAM: High-Fidelity Neural Structured-Light Depth for Practical SLAM and Reconstruction}. Preprint.
        \end{highlights}
        \vspace{0.2cm}
    ...
    \begin{onecolentry}
        \textbf{EpiS: Neural Surface Reconstruction from Sparse Views Using Epipolar Geometry} \hfill CVPRW 2026
    \end{onecolentry}
    \begin{onecolentry}
        \begin{highlights}
    ...
    \begin{onecolentry}
        \textbf{SplatMesh: Interactive 3D Segmentation and Editing} \hfill CVPRW 2025
    \end{onecolentry}
    \begin{onecolentry}
        \begin{highlights}
    ...
    \begin{onecolentry}
        \textbf{Stream3D: Sequential Multi-View 3D Generation via Evidential Memory} \hfill Preprint
    \end{onecolentry}
    \begin{onecolentry}
        \begin{highlights}
        \item A sequential multi-view 3D generation method using evidential memory for consistent high-quality generation.
        \item Roadmap: Enables consistent 3D asset generation for scalable digital twin creation.\hspace{4pt}\cvdot
        \end{highlights}
    \end{onecolentry}
